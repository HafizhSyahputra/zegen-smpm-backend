...
export class JobOrderReportService {  
  ...
  async findAll(pageOptionJOReportDto: PageOptionJOReportDto): Promise<PageDto<JobOrderReport>> {  
    const { skip, take, order, order_by, search, search_by } = pageOptionJOReportDto;  
